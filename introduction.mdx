...
The application was refactored and upgraded from legacy Laravel/Vue versions to modern standards — Laravel 11, PHP 8.3, and Vue.js — improving reliability, code maintainability, and feature completeness.
